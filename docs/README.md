...
- [`docs/capacity.md`](capacity.md) — подсказки ёмкости payload и рекомендации по `h2k.capacityHint`.
...
- [`docs/java-setup.md`](java-setup.md) — настройка Java 8 для сборки проекта (автоопределение JDK, ручная конфигурация, troubleshooting).
- [`docs/codacy-setup.md`](codacy-setup.md) — установка и настройка Codacy CLI v2 для WSL-окружений.
