...
public final class BatchSender implements AutoCloseable {
    ...
    public interface Listener {
         ...
         * Вызывается, когда {@link #tryFlush()} не смог дождаться подтверждений, но исключение
         * было подавлено. Позволяет наблюдателю зафиксировать факт деградации и адаптировать
