...
public final class TopicDescribeHandler {
    ...
    public TopicExistence describeSingle(String topic) {
        try {
            ...
            return retryUnknown(topic);
        } catch (java.util.concurrent.TimeoutException ex) {
            return retryUnknownTimeout(topic, ex);
    ...
    private TopicExistence retryUnknown(String topic) {
        backoffManager.scheduleRetry(topic);
        return TopicExistence.UNKNOWN;
    }

    private TopicExistence retryUnknownTimeout(String topic, java.util.concurrent.TimeoutException ex) {
        if (LOG.isDebugEnabled()) {
